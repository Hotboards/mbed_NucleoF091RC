...
Now is easier than ever to use **mbed** library offline with eclipse and GNU ARM. In this repository you will find a eclipse project with mbed library for ST [**NucleoF091RC**](http://developer.mbed.org/platforms/ST-Nucleo-F091RC/) board.
...
**https://github.com/Hotboards/mbed_NucleoF091RC.git**
